  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      preview: 'Welcome to your account! We\'re excited to have you on board. Feel free to explore the dashboard.',
    ...
    },
    {
      ...
      preview: 'Here are some tips to help you get started with your new account. Check out the features available to you.',
      timestamp: '1 day ago',
      read: false
    }
  ]);
