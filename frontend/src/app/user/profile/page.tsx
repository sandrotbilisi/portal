            ...
            <div className="bg-gray-800/30 backdrop-blur-xl border border-gray-600/20 rounded-2xl p-6 shadow-2xl">
              <div className="flex items-center space-x-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-400 capitalize">{me?.role} Account</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between py-3 border-b border-gray-700/30">
                  ...
                  <span className="text-white font-medium">{me?.branchLocation}</span>
                </div>
                <div className="flex justify-between py-3 border-b border-gray-700/30">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between py-3 border-b border-gray-700/30">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Logged in</p>
