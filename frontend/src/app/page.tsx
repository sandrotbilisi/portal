                  ...
                  {filteredFolders.map((folder, index) => (
                    <div
                      ...
                      className={`group relative bg-gray-700/30 backdrop-blur-md border border-gray-600/20 rounded-xl p-4 hover:bg-gray-600/40 hover:border-gray-500/30 transition-all duration-300 hover:scale-105 hover:shadow-xl ${
                        folder.type === 'folder' || isImageFile(folder.name) || folder.type === 'youtube' || folder.name.toLowerCase().endsWith('.pdf') || isVideoFile(folder.name) || isDocumentFile(folder.name) ? 'cursor-pointer' : 'cursor-default'
                      } ${
                    ...
                    >
                      ...
                      <div className={`relative z-10 text-sm text-gray-400 group-hover:text-gray-300 transition-colors duration-300 ${
